...
module.exports = {
    getHomeListShopGamePhanLoaiNam_PhanTrang: (req, res) => { 
        if (req.query.page) {
            return res.redirect(`/shop-list-phan-loai-game-nam?page=${req.query.page}`)
        }
        res.redirect(`/shop-list-phan-loai-game-nam`)
    },
    ...
    getHomeListShopGamePhanLoaiNu_PhanTrang: (req, res) => { 
        if (req.query.page) {
            return res.redirect(`/shop-list-phan-loai-game-nu?page=${req.query.page}`)
        }
        res.redirect(`/shop-list-phan-loai-game-nu`)
    },
